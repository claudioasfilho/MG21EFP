...
uint8_t bg_gattdb_data_attribute_field_29_data[5]={0x00,0x00,0x00,0x00,0x00,};
...
uint8_t bg_gattdb_data_attribute_field_10_data[13]={0x45,0x46,0x50,0x5f,0x54,0x65,0x73,0x74,0x00,0x00,0x00,0x00,0x00,};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x000c,.permissions=0x807,.caps=0xffff,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x01,.index=0x05,.clientconfig_index=0x01}},
    ...
    {.uuid=0x000b,.permissions=0x800,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_29},
    {.uuid=0x000c,.permissions=0x803,.caps=0xffff,.datatype=0x03,.min_key_size=0x00,.configdata={.flags=0x02,.index=0x06,.clientconfig_index=0x02}},
};
